...

{
  ...
  $("#supermarquee").supermarquee({
    ...
    position: "custom",
    content:
      "- HTML - Css - TypeScript - Javascript - Jquery - Tailwind - Material UI - Reactjs - Next Js - Redux - Jest - Node Js - Express js - Python - PHP - Laravel 10 - MongoDB - PostgreSQL - Mysql - Hooks - Git - Github - Responsive design - slick js"
  });
}

{
  ...
  $("#supermarquee-01").supermarquee({
    ...
    <img src="assets/images/icon/020.png" alt="typescript">
